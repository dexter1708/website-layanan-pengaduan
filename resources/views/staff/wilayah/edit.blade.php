            ...
            <div class="p-6 text-gray-900">
                ...
                <div class="mb-6">
                    ...
                    <p class="text-gray-600">
                        Edit data wilayah yang sudah ada dalam sistem.
                    </p>
                </div>
                ...
                <form action="{{ route('staff.wilayah.update', ['type' => $tipe, 'id' => $id]) }}" method="POST">
                    ...
                    @if($tipe === 'kota')
                        <div class="mb-4">
                            ...
                            <input type="text" name="nama" id="nama_kota" value="{{ old('nama', $wilayah->kota_nama ?? '') }}" 
                    ...
                    @if($tipe === 'kecamatan')
                        <div class="mb-4">
                            ...
                            <input type="text" name="nama" id="nama_kecamatan" value="{{ old('nama', $wilayah->kecamatan_nama ?? '') }}" 
                                   class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" 
                    ...
                    @if($tipe === 'desa')
                        <div class="mb-4">
                            ...
                            <input type="text" name="nama" id="nama_desa" value="{{ old('nama', $wilayah->desa_nama ?? '') }}" 
                                   class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" 
