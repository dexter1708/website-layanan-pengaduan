    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div class="bg-white rounded-lg shadow-md">
            ...
            <div class="p-6 border-b border-gray-200">
                <h2 class="text-2xl font-bold text-gray-800">Buat Jadwal Konseling</h2>
                <p class="text-sm text-gray-600 mt-1">Isi formulir di bawah ini untuk membuat jadwal konseling baru.</p>
            </div>

            <!-- Form -->
            <form action="{{ route('staff.konseling.store') }}" method="POST" class="p-8">
                @csrf
                <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                    ...
                    <div>
                        ...
                        <input type="date" id="tanggal_konseling" name="tanggal_konseling" class="w-full px-4 py-2 bg-gray-50 border rounded-lg" required>
                    </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea id="tempat_konseling" name="tempat_konseling" rows="3" class="w-full px-4 py-2 bg-gray-50 border rounded-lg" required></textarea>
                    </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <select id="konfirmasi" name="konfirmasi" class="w-full px-4 py-2 bg-gray-50 border rounded-lg" required>
                            <option value="{{ App\Models\Konseling::STATUS_MENUNGGU_KONFIRMASI_USER }}" selected>Menunggu Konfirmasi User</option>
                            <option value="{{ App\Models\Konseling::STATUS_BUTUH_KONFIRMASI_STAFF }}">Butuh Konfirmasi Staff</option>
                            <option value="{{ App\Models\Konseling::STATUS_TERKONFIRMASI }}">Terkonfirmasi</option>
                            <option value="{{ App\Models\Konseling::STATUS_DIBATALKAN }}">Dibatalkan</option>
                        </select>
                    </div>
                </div>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    layananSelect.addEventListener('change', function () {
        ...
        konselorSelect.innerHTML = '<option value="">-- Pilih Konselor --</option>'; // Reset
