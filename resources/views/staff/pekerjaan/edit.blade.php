            ...
            <div class="p-6 text-gray-900">
                ...
                <div class="mb-6">
                    ...
                    <p class="text-gray-600">
                        Edit data pekerjaan yang sudah ada dalam sistem.
                    </p>
                </div>
                ...
                <div class="flex justify-center">
                    <div class="bg-white shadow-md rounded-lg p-6 max-w-xl w-full">
                        <form method="POST" action="{{ route('staff.pekerjaan.update', $pekerjaan->id) }}" class="space-y-6">
                            @csrf
                            @method('PUT')

                            <div class="mb-4">
                                <label for="pekerjaan" class="block text-sm font-medium text-gray-700 mb-2">Nama Pekerjaan</label>
                                <input type="text" name="pekerjaan" id="pekerjaan" value="{{ old('pekerjaan', $pekerjaan->pekerjaan) }}" 
