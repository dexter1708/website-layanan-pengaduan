    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        <div class="text-gray-900 text-lg font-semibold mb-2">Total Assessment</div>
                        <div class="text-3xl font-bold text-purple-600">{{ $totalAssessment }}</div>
                    </div>
                </div>
                -->
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        <div class="text-gray-900 text-lg font-semibold mb-2">Total Konseling</div>
                        <div class="text-3xl font-bold text-indigo-600">{{ $totalKonseling }}</div>
                    </div>
                </div>
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        <div class="text-gray-900 text-lg font-semibold mb-2">Total Pendampingan</div>
                        <div class="text-3xl font-bold text-pink-600">{{ $totalPendampingan }}</div>
                    </div>
                </div>
            </div>
