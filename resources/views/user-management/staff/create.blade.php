...
<section class="bg-white py-6 px-4 sm:px-6 lg:px-8">
    ...
    <nav class="text-sm text-gray-600 font-semibold mb-6" aria-label="Breadcrumb">
        <ol class="flex items-center space-x-2">
            ...
            <li class="text-gray-600">/</li>
            <li class="text-gray-500">Tambah Staff Baru</li>
        </ol>
    </nav>

    <!-- Header Section -->
    <div class="mb-8">
        <h1 class="text-3xl font-bold text-gray-900 mb-2">Tambah Staff Baru</h1>
        <p class="text-gray-600">Buat akun staff baru untuk mengelola sistem</p>
    </div>
    ...
    <div class="bg-white rounded-lg shadow-md p-6">
        <form method="POST" action="{{ route('admin.staff.store') }}" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <!-- Password -->
                <div>
                    <label for="password" class="block font-semibold text-gray-800 mb-2">Password *</label>
                ...
                <!-- Confirm Password -->
                <div>
                    <label for="password_confirmation" class="block font-semibold text-gray-800 mb-2">Konfirmasi Password *</label>
